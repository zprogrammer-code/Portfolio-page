...
function PortfolioNavbar() {
    ...
    return(
        ...
        <Navbar bg='grey' varient='dark' className='navbar-nav'>
               ...
               <a href="/home" id='logo'><h1>ZPROGRAMMERCODE</h1></a>
      
                                <Button href="/Home" className=" block-example border border-0 border-dark" variant="outline-dark">
  ...
  Home
                                ...
                                <Button href="/Storehttps://www.linkedin.com/in/zachary-jacobs-10b3351b5/" className=" block-example border border-0 border-dark" variant="outline-dark">
...
<a href='https://www.linkedin.com/in/zachary-jacobs-10b3351b5/'>Linkdin</a>

                                </Button>
                              
                                <Button href="/Contact" className=" block-example border border-0 border-dark" variant="outline-dark">
  ...
  <path fill-rule="evenodd" d="M1.885.511a1.745 1.745 0 0 1 2.61.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.678.678 0 0 0 .178.643l2.457 2.457a.678.678 0 0 0 .644.178l2.189-.547a1.745 1.745 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.634 18.634 0 0 1-7.01-4.42 18.634 18.634 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877L1.885.511z"/>
                                ...
                                <Button href="/CheckOut" className=" block-example border border-0 border-dark" variant="outline-dark">
