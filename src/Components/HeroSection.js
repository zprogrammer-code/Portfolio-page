            ...
            <iframe src="https://drive.google.com/file/d/1WFCAQmSPbIy10GzVNSBS-3MGq8tY-CnW/preview" width="450" height="480" allow="autoplay" title='myFace'></iframe>              
             <div className='info'>
              <h1 className='namefont'> Hi, My name is Zachary Jacobs</h1>
                    <p className='summary'>Im a fullstack software developer and digital marketer. My specialties
                     are <s className='txtdec'>Javascript/React.js & React Native, Redux, Sass/CSS,
                    Ruby/Rails and node/mySQL.</s> Java, Ruby and Javascript
                    ...
                    <h2>Click on the <a>M</a> to send me an email
                    </h2>
            </div>
            </div>
        </div>
